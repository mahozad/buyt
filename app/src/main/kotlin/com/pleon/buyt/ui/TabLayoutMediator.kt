...
class TabLayoutMediator(private val mTabLayout: TabLayout, private val mViewPager: ViewPager2,
                        private val mAutoRefresh: Boolean,
                        private val mOnConfigureTabCallback: OnConfigureTabCallback) {
    ...
    companion object {
        ...
        init {
            try {
                sSetScrollPosition = TabLayout::class.java.getDeclaredMethod("setScrollPosition", Int::class.javaPrimitiveType,
